        ...
        */}
        <div className="absolute left-1/2 top-[30px] flex w-full max-w-[345px] -translate-x-1/2 flex-col items-center gap-6 px-6 tab:top-1/2 tab:max-w-[836px] tab:-translate-y-1/2 tab:px-0">
          ...
          <div className="flex w-[174px] flex-col items-center gap-6 tab:w-auto">
            <Link
              href="/signup"
              className="press flex h-[62px] min-h-12 items-center justify-center whitespace-nowrap rounded-md bg-primary-default px-6 font-heading text-[18px] font-semibold leading-[22px] tracking-[-1px] text-text-on-primary tab:text-[20px] tab:leading-[24px] web:text-[32px] web:leading-[39px]"
            >
              Start Free Trial
            </Link>
